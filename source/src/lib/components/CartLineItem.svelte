<script lang="ts">
	...
	import { getPrimaryImage, productSlug } from '$lib/utils/product';
	...
	const href = $derived(
		product
			? resolve('/products/[slug]', { slug: productSlug(product) })
			: resolve('/products')
	);
</script>

<div class="cart-line">
	<a {href} class="cart-line__image">
		{#if imageUrl}
