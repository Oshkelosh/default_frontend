/** Subdivision codes accepted by Printful / Gelato / Printify for US, CA, AU. */
...
/** Return subdivision options for a country code, or [] when none. */
export function statesForCountry(countryCode: string | null | undefined): StateOption[] {
